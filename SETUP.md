# 🚀 Muhammad Azan Portfolio - Complete Setup Guide
...
- 🤖 **AZAN AI** - Smart chatbot answering questions about Azan
...
```html
<!-- Find and edit these: -->
<span class="gradient">Muhammad Azan</span>
...
- **Design**: Muhammad Azan
- **AI**: Groq (llama-3.1-8b-instant)
- **Inspiration**: Neon/cyberpunk aesthetic

---

> Made with ❤️ by Azan | © 2026